...
from contracts import ColorStreamContract
    ...
    def run_camera_stream(self):
        while True:
            try:
                ...
                self._color-array = PiRGBArray(self._camera)
                ...
                while True:
                    ...
                    self._camera.capture(self._color-array, format = 'bgr')
                    color_image = self._color-array.array
